...
struct OnboardingProfileSetupView: View {
    ...
    private func saveProfile() {
        ...
        seekerProfile.cleanlinessLevel = Int(cleanlinessLevel)
        seekerProfile.sleepSchedule = sleepSchedule
        seekerProfile.smokingPreference = smokingPreference
        seekerProfile.foodPreference = foodPreference
